System.register(['aurelia-dependency-injection', 'aurelia-templating', './aurelia-plugins-google-recaptcha-config'], function (_export, _context) {
  ...
  var inject, bindable, customElement, noView, Config;
  return {
    ...
    execute: function () {
      ...
      let Recaptcha = (_dec = customElement('aup-google-recaptcha'), _dec2 = noView(), _dec3 = inject(Element, Config), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class Recaptcha {
